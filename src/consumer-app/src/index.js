...
const serviceName = process.env.SERVICE_NAME || 'consumer-app-service';
...
app.get('/consumers', (req, res) => {
  res.json([
    { id: 'c1', name: 'Alice Johnson', email: 'alice@example.com', tier: 'premium' },
    { id: 'c2', name: 'Bob Smith', email: 'bob@example.com', tier: 'standard' }
  ]);
});

app.get('/consumers/:id', (req, res) => {
  res.json({ id: req.params.id, name: 'Alice Johnson', email: 'alice@example.com', tier: 'premium' });
});
