...
const serviceName = process.env.SERVICE_NAME || 'driver-app-service';
...
app.get('/drivers', (req, res) => {
  res.json([
    { id: 'd1', name: 'John Doe', vehicle: 'Tesla Model 3', status: 'available' },
    { id: 'd2', name: 'Jane Smith', vehicle: 'Toyota Prius', status: 'busy' }
  ]);
});

app.get('/drivers/:id', (req, res) => {
  res.json({ id: req.params.id, name: 'John Doe', vehicle: 'Tesla Model 3', status: 'available' });
});
